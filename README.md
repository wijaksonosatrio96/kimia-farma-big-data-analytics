...
1. Tren Pendapatan: Penjualan mencapai puncak pada periode 2021 Q3, selaras dengan kebutuhan obat-obatan dan layanan kesehatan selama gelombang pandemi. Terdapat normalisasi pendapatan di tahun 2023.
2. Area Dominan: Provinsi Jawa Barat dan Jakarta menyumbang lebih dari 40% total profit nasional, namun memiliki tingkat persaingan diskon yang tinggi (discount_percentage rata-rata di atas 15%).
3. Kualitas Layanan: Terdapat 5 cabang di wilayah Timur Indonesia yang memiliki rating_cabang sangat tinggi namun rating_transaksi di bawah rata-rata nasional.
